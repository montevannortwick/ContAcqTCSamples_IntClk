    ...
    public class MainForm : System.Windows.Forms.Form
    {
      private int nSamplesPerChannel = 1;
        ...
        public MainForm()
        {
            ...
            thermocoupleTypeComboBox.SelectedIndex = 7;
      ...
      this.acquisitionDataGrid.Location = new System.Drawing.Point(288, 162);
      ...
      this.acquisitionDataGrid.Size = new System.Drawing.Size(2178, 200);
      ...
      this.ClientSize = new System.Drawing.Size(2462, 416);
        ...
        private void CreateTask()
        {
          ...
          try
          {
            ...
            switch (cjcSourceComboBox.SelectedIndex)
            {
              ...
              case 2: // Internal
              default:
                //myChannel = myTask.AIChannels.All;

                string strPhysicalChannels = "cDAQ1Mod1/ai0:cDAQ1Mod1/ai15,cDAQ1Mod2/ai0:cDAQ1Mod2/ai15,cDAQ1Mod3/ai0:cDAQ1Mod3/ai7";
                myChannel = myTask.AIChannels.CreateThermocoupleChannel(strPhysicalChannels,
                    "", Convert.ToDouble(minimumValueNumeric.Value), Convert.ToDouble(maximumValueNumeric.Value),
                    thermocoupleType, AITemperatureUnits.DegreesC);
                int nChannelCount = myTask.AIChannels.Count;
                break;
            }
            ...
            double dRate = (double)rateNumeric.Value;

            dRate = 2D;
            int nBufferSize = (int)(dRate * 10D);
            myTask.Timing.ConfigureSampleClock("", dRate,
                SampleClockActiveEdge.Rising, SampleQuantityMode.ContinuousSamples, nBufferSize);

            myTask.Control(TaskAction.Verify);
            AIAdcTimingMode timingMode = myChannel.AdcTimingMode;  // get value to save
            myChannel.AdcTimingMode = AIAdcTimingMode.HighSpeed;
            double dMaxClock = myTask.Timing.SampleClockMaximumRate;
            ...
            Trace.WriteLine("BeginReadWaveform");
            analogInReader.BeginReadWaveform(nSamplesPerChannel, myAsyncCallback, myTask);
          }
          ...
          double[] dDataArray = new double[40];
            try
            {
                if (runningTask != null && runningTask == ar.AsyncState)
                {
                    ...
                    //long lBufferSpaceAvail = myTask.Stream.OutputBufferSpaceAvailable;
                    //Trace.WriteLine("lBufferSpaceAvail=" + lBufferSpaceAvail);
                }
            }
            catch (DaqException exception)
            {
